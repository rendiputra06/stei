...
namespace App\Filament\Mahasiswa\Resources\KRSResource\RelationManagers;
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ...
                    ->visible(fn() => $this->getOwnerRecord()->isDraftStatus() && KRSResource::dapatMengisiKRS())
                    ...
                    ->mutateFormDataUsing(function (array $data): array {
                        ...
                        if ($bentrok) {
                            Notification::make()
                                ...
                                ->body('Jadwal mata kuliah ini bentrok dengan mata kuliah lain yang sudah Anda pilih.')
                                ->danger()
                                ->send();
            ...
            ->emptyStateDescription('Silakan tambahkan mata kuliah yang ingin diambil dengan klik tombol "Tambah Mata Kuliah" di atas.')
            ->emptyStateActions([
                Tables\Actions\CreateAction::make()
                    ->label('Tambah Mata Kuliah')
                    ->visible(fn() => $this->getOwnerRecord()->isDraftStatus() && KRSResource::dapatMengisiKRS()),
